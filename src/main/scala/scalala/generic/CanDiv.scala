...
object CanDiv {
  ...
  implicit def unaryLeft[V1,RV]
  : UnaryLeft[V1,RV] = new UnaryLeft[V1,RV] { def apply(v : V1) = throw new ArithmeticException("/ by zero"); }
  ...
  implicit object divDD extends CanDiv[Double,Double,Double]
