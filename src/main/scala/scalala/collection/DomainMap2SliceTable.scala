...
[@specialized(Int,Long) A1, @specialized(Int,Long) A2,
 ...
 +This<:DomainMap2SliceTable[A1,A2,B,Coll]]
...
[@specialized(Int,Long) A1, @specialized(Int,Long) A2,
 @specialized(Int,Long,Float,Double,Boolean) B,
 +Coll<:DomainMap2[A1,A2,B]]
extends DomainMapSlice[(A1,A2),(Int,Int),B,Coll]
with DomainTable[B]
with DomainMap2SliceTableLike[A1,A2,B,IterableDomain[A1],IterableDomain[A2],Product2Domain[A1,A2],Product2Domain[A2,A1],Coll,DomainMap2SliceTable[A1,A2,B,Coll]];
