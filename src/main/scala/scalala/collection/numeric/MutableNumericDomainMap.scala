...
//
///**
// * A Mutable Tensor with numeric values.
// *
// * @author dramage
// */
//trait MutableNumericTensorLike
//[@specialized(Int,Long) A, @specialized(Int,Long,Float,Double) B,
// +D<:IterableDomain[A] with DomainLike[A,D],
// +This<:MutableNumericTensor[A,B]]
//extends NumericTensorLike[A,B,D,This]
//with MutableTensorLike[A,B,D,This]
...
//}
//
//trait MutableNumericTensor
//[@specialized(Int,Long) A, @specialized(Int,Long,Float,Double) B]
//extends NumericTensor[A,B] with MutableTensor[A,B]
//with MutableNumericTensorLike[A,B,IterableDomain[A],MutableNumericTensor[A,B]]
//
//object MutableNumericTensor {
//
//  def apply[A, B]
...
//  extends MutableTensor.Impl[A,B](_map, _default, _domain)
//  with MutableNumericTensor[A,B];
//}
